...
if [ $TOTAL_ISSUES -eq 0 ]; then
    ...
    echo "1. Run: .github/setup-federated-identity.sh"
    echo "2. Run: .github/setup-github-secrets.sh"
    echo "3. Run the 'Setup Terraform Backend' workflow"
    echo "4. Run the 'Deploy Terraform Infrastructure' workflow"
...
Next Steps:
1. Configure federated identity and Azure resources
